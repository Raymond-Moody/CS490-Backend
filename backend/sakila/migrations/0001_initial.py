    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField(blank=True, null=True)),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='sakila.address')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='sakila.store')),
            ],
            options={
                'db_table': 'customer',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField()),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='sakila.customer')),
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='sakila.inventory')),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='sakila.staff')),
            ],
            options={
                'db_table': 'rental',
                'managed': True,
